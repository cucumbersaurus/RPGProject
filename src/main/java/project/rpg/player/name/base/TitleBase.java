...
public abstract class TitleBase {  //칭호 베이스
    ...
    protected Player _player;  //플레이어 onEnable 이나 disable 에서 쓸때
    protected String _name;   //칭호 이릉
    protected String _desciption;  //칭호 설명
    protected String _acquisitionConditions;  //획득 조건
